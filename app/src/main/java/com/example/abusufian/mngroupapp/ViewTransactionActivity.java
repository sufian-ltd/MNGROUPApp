...
public class ViewTransactionActivity extends AppCompatActivity {
    ...
    public void delete(){
        ...
        Call<ServerResponse> call=apiInterface.deleteCustomerTransaction(id);
        call.enqueue(new Callback<ServerResponse>() {
            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                ...
                if(message.equals("delete")){
                    Toast.makeText(ViewTransactionActivity.this, "deleted", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
            ...
            public void onFailure(Call<ServerResponse> call, Throwable t) {
                Toast.makeText(ViewTransactionActivity.this, "Please check internet connection", Toast.LENGTH_SHORT).show();
            }
        });
    }
    public void search() {
        ...
        if(name.equals("") || name.equals("select customer")){
            Toast.makeText(this, "Please select customer", Toast.LENGTH_SHORT).show();
            return;
        }
        ApiInterface apiInterface = ApiClient.getRetrofit().create(ApiInterface.class);
        Call<List<Product>> call = apiInterface.getCustomer(name);
    ...
    public void initialize(){
        ...
        call.enqueue(new Callback<List<Product>>() {
            ...
            @Override
            public void onFailure(Call<List<Product>> call, Throwable t) {
                Toast.makeText(ViewTransactionActivity.this, "something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
